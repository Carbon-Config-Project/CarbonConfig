...
import carbonconfiglib.gui.impl.ModConfigList;
...
public class EventHandler implements IConfigChangeListener
{
	...
	Object2ObjectMap<String, IModConfigs> allKnownConfigs = new Object2ObjectLinkedOpenHashMap<>();
