...
{
	public static final NamedRegistry<Block> BLOCKS = NamedRegistry.ofRegistry(Registry.BLOCK, T -> T.getName().getString());
	public static final NamedRegistry<Item> ITEMS = NamedRegistry.ofRegistry(Registry.ITEM, T -> T.getName(T.getDefaultInstance()).getString());
	public static final NamedRegistry<Fluid> FLUID = NamedRegistry.ofRegistry(Registry.FLUID, T -> I18n.get(Util.makeDescriptionId("fluid", Registry.FLUID.getKey(T))));
	public static final NamedRegistry<MobEffect> MOB_EFFECTS = NamedRegistry.ofRegistry(Registry.MOB_EFFECT, T -> T.getDisplayName().getString());
	public static final NamedRegistry<Enchantment> ENCHANTMENTS = NamedRegistry.ofRegistry(Registry.ENCHANTMENT, T -> T.getFullname(0).plainCopy().getString());
