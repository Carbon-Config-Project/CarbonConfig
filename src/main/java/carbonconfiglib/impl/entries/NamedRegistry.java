...
public class NamedRegistry<T>
{
	...
	public static final NamedRegistry<Fluid> FLUID = NamedRegistry.ofRegistry(BuiltInRegistries.FLUID, T -> I18n.get(Util.makeDescriptionId("fluid", BuiltInRegistries.FLUID.getKey(T))));
