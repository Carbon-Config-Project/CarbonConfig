...
public class WidgetAligner
{
	...
	public void applyToPose(double screenWidth, double screenHeight, double width, double height) {
		GlStateManager.translate(screenX.alignStart(0F, screenWidth, width*scale)+xOffset*screenWidth, screenY.alignStart(0F, screenHeight, height*scale)+yOffset*screenHeight, 0F);
