...
public class CarbonConfig
{
	...
	public static void openRemoteConfigFolder(IModConfig config, BackgroundTexture texture, String...path) {
		...
		if (mc.player == null) {
			...
			return;
		} else if (!mc.isSingleplayer() && mc.player.getPermissionLevel() < 4) {
	...
	public void onClientLoad() {
		...
		DEPENDENCY_VIEWER = () -> GameSettings.isKeyDown(mappingOther) && mappingOther.getKeyConflictContext().isActive() && mappingOther.getKeyModifier().isActive(mappingOther.getKeyConflictContext());
	}
