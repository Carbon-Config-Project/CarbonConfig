...
public class CarbonConfig
{
	...
	public void onKeyPressed(KeyInputEvent event) {
		...
		if (mc.player != null && MOD_GUI.getAsBoolean() && event.getAction() == GLFW.GLFW_PRESS) {
			mc.displayGuiScreen(Screen.hasShiftDown() ? new GuiModList(mc.currentScreen) : new ConfigListScreen(mc.currentScreen, BackgroundTexture.DEFAULT.asHolder(), EventHandler.INSTANCE.getAllConfigs()));
		}
