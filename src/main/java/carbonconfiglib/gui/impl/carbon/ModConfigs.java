...
public class ModConfigs implements IModConfigs
{
	...
	public static ModConfigs of(String modId) {
		return new ModConfigs(FabricLoader.getInstance().getModContainer(modId).orElse(null));
	}
	
	public static ModConfigs of(String modId, ConfigHandler handler) {
		ModConfigs configs = new ModConfigs(FabricLoader.getInstance().getModContainer(modId).orElse(null));
