...
public class CarbonValue implements IValueNode, IValueActions
{
	...
	public CarbonValue(String nodeName, IReloadMode mode, IChatComponent name, IChatComponent tooltip, IEntrySettings settings, IStructuredData data, boolean forced, Supplier<List<Suggestion>> suggestions, String current, String defaultValue, Function<String, ParseResult<Boolean>> isValid, BiConsumer<String, IValueActions> saveAction) {
