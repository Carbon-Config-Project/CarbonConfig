...
public class ForgeValue implements IValueNode
{
	...
	public ForgeValue(String nodeName, IChatComponent name, IChatComponent tooltip, IEntrySettings settings, ReloadMode mode, DataType type, IRange range, String value, String defaultValue, Supplier<List<Suggestion>> suggestions, Function<String, ParseResult<?>> isValid, BiConsumer<String, ForgeValue> saved) {
