...
public class ForgeArray implements IArrayNode
{
	...
	public ForgeArray(String nodeName, IChatComponent name, IChatComponent tooltip, IEntrySettings settings, ReloadMode mode, DataType type, IRange range, List<String> value, List<String> defaultValue, Supplier<List<Suggestion>> suggestions, Function<String, ParseResult<?>> isValid, Consumer<List<String>> saved) {
