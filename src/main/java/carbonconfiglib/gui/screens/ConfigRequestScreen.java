...
{
	static final ITextComponent REQUEST = Texts.translatable("gui.carbonconfig.requesting_config");
	static final ITextComponent[] ANIMATION = new ITextComponent[] {
			Texts.literal("Ooooo").setStyle(Texts.applyStyle(TextFormatting.GRAY)),
			Texts.literal("oOooo").setStyle(Texts.applyStyle(TextFormatting.GRAY)),
			Texts.literal("ooOoo").setStyle(Texts.applyStyle(TextFormatting.GRAY)),
			Texts.literal("oooOo").setStyle(Texts.applyStyle(TextFormatting.GRAY)),
			Texts.literal("ooooO").setStyle(Texts.applyStyle(TextFormatting.GRAY)),
	...
	public void renderForeground(int mouseX, int mouseY, float partialTicks) {
		...
		drawText( Texts.translatable("gui.carbonconfig.timeout", timeout).setStyle(Texts.applyStyle(TextFormatting.RED)), 0, 9, Align.CENTER, -1);
