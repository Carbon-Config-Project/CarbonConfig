...
public class MultiChoiceScreen extends BaseCarbonScreen
{
	...
	public void initGui() {
		super.initGui();
		this.addButtons(MathHelper.clamp(this.messageTop() + this.messageHeight() + 20, this.height / 6 + 96, this.height - 24) - centerY);
	}
	...
	private int messageHeight() {
		return fontRenderer.listFormattedStringToWidth(message.getFormattedText(), width-50).size() * 9;
	}
