...
public interface IConfigNode
{
	...
	public static IFormattableTextComponent createLabel(String name, String translationKey) {
		return translationKey != null && I18n.exists(translationKey) ? Texts.translatable(translationKey) : createLabel(name);
	}
	
	public static IFormattableTextComponent createLabel(String name) {
