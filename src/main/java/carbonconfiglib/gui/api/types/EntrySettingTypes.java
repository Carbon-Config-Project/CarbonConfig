...
{	
	public static class CompoundArrayNamer<T> implements IEntrySettings {
		...
		final Function<T, IChatComponent> provider;
		
		public CompoundArrayNamer(Supplier<IConfigSerializer<T>> serializer, Function<T, IChatComponent> provider) {
			this.serializer = serializer;
			this.provider = provider;
		}
		
		public Function<T, IChatComponent> provider() {
			return provider;
		}
