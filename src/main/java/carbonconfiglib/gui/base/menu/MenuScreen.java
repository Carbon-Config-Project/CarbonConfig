...
public class MenuScreen extends BaseCarbonScreen {
	...
	public void drawBackground(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
		drawArea(graphics, menuX, menuY, realWidth-1, realHeight-5);
	}
	
	public void drawArea(GuiGraphics graphics, float x, float y, float widht, float height) {
		...
		fillGradient(graphics, minX - 3, minY - 4, maxX + 3, minY - 3, -267386864, buffer);
		fillGradient(graphics, minX - 3, maxY + 3, maxX + 3, maxY + 4, -267386864, buffer);
		fillGradient(graphics, minX - 3, minY - 3, maxX + 3, maxY + 3, -267386864, buffer);
		fillGradient(graphics, minX - 4, minY - 3, minX - 3, maxY + 3, -267386864, buffer);
		fillGradient(graphics, maxX + 3, minY - 3, maxX + 4, maxY + 3, -267386864, buffer);
		
		fillGradient(graphics, minX - 3, minY - 3 + 1, minX - 3 + 1, maxY + 3 - 1, 1347420415, buffer);
		fillGradient(graphics, maxX + 2, minY - 3 + 1, maxX + 3, maxY + 3 - 1, 1347420415, buffer);
		fillGradient(graphics, minX - 3, minY - 3, maxX + 3, minY - 3 + 1, 1347420415, buffer);
		fillGradient(graphics, minX - 3, maxY + 2, maxX + 3, maxY + 3, 1344798847, buffer);
	...
	protected void fillGradient(GuiGraphics graphics, float left, float top, float right, float bottom, int color, BufferBuilder buffer) {
