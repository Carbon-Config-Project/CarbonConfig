...
public class CarbonSlider extends CarbonBaseButton {
	...
	public void renderButton(int pMouseX, int pMouseY, float pPartialTick) {
	      ...
	      GuiUtils.blitWithBorder(WIDGETS_LOCATION, x, y, 0, 46 + i * 20, this.width, this.height, 200, 20, 2, 3, 2, 2, this.getBlitOffset(), false);
	...
	protected void renderBg(Minecraft mc, int mouseX, int mouseY) {
		...
		GuiUtils.blitWithBorder(WIDGETS_LOCATION, this.x + (int)(range * (float)(this.width - 8)), this.y, 0, 46 + i, 8, this.height, 200, 20, 2, 3, 2, 2, this.getBlitOffset(), true);
	}
