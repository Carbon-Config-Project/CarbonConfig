...
public class CarbonSlider extends CarbonBaseButton {
	...
	public void render(int pMouseX, int pMouseY, float pPartialTick) {
		...
		GuiUtils.blitWithBorder(BUTTON_TEXTURES, xPosition, yPosition, 0, 46 + i * 20, this.width, this.height, 200, 20, 2, 3, 2, 2, zLevel, false);
	...
	protected void renderBg(Minecraft mc, int mouseX, int mouseY) {
		...
		GuiUtils.blitWithBorder(BUTTON_TEXTURES, this.xPosition + (int)(range * (float)(this.width - 8)), this.yPosition, 0, 46 + i, 8, this.height, 200, 20, 2, 3, 2, 2, zLevel, true);
	}
