...
public class CarbonSlider extends CarbonBaseButton {
	...
	public void renderWidget(GuiGraphics graphics, int pMouseX, int pMouseY, float pPartialTick) {
	      ...
	      GuiUtils.blitWithBorder(graphics, WIDGETS_LOCATION, getX(), getY(), 0, 46, this.width, this.height, 200, 20, 2, 3, 2, 2, false);
	...
	protected void renderBg(GuiGraphics graphics, Minecraft mc, int mouseX, int mouseY) {
		...
		GuiUtils.blitWithBorder(graphics, WIDGETS_LOCATION, this.getX() + (int)(range * (float)(this.width - 8)), this.getY(), 0, 46 + i, 8, this.height, 200, 20, 2, 3, 2, 2, true);
	}
