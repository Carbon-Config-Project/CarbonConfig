...
public class CarbonSlider extends CarbonBaseButton {
	...
	public void renderWidget(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
	      ...
	      GuiUtils.blitWithBorder(pPoseStack, WIDGETS_LOCATION, getX(), getY(), 0, 46, this.width, this.height, 200, 20, 2, 3, 2, 2, 0, false);
	...
	protected void renderBg(PoseStack stack, Minecraft mc, int mouseX, int mouseY) {
		...
		GuiUtils.blitWithBorder(stack, WIDGETS_LOCATION, this.getX() + (int)(range * (float)(this.width - 8)), this.getY(), 0, 46 + i, 8, this.height, 200, 20, 2, 3, 2, 2, 0, true);
	}
