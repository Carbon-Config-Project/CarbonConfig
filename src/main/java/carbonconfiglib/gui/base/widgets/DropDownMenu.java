...
public class DropDownMenu<T> extends CarbonButton {
	...
	public void renderButton(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
		...
		ScreenUtils.blitWithBorder(poseStack, WIDGETS_LOCATION, this.getX(), this.getY(), 0, 46 + k * 20, this.width-14, this.height, 200, 20, 2, 3, 2, 2, this.getBlitOffset());
		ScreenUtils.blitWithBorder(poseStack, WIDGETS_LOCATION, this.getX()+width-15, this.getY(), 0, 46 + k * 20, 15, this.height, 200, 20, 2, 3, 2, 2, this.getBlitOffset());
