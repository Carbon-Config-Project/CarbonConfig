	...
	public void renderButton(int mouseX, int mouseY, float partialTick) {
		if(state.isSimpleButton()) {
			...
			if(icon != null) {
				...
				GuiUtils.blitWithBorder(WIDGETS_LOCATION, this.x, this.y, 0, 46 + k * 20, this.width, this.height, 200, 20, 2, 3, 2, 2, blitOffset, false);
		...
		GuiUtils.blitWithBorder(WIDGETS_LOCATION, this.x, this.y, 0, 46 + k * 20, this.width-14, this.height, 200, 20, 2, 3, 2, 2, blitOffset, false);
		GuiUtils.blitWithBorder(WIDGETS_LOCATION, this.x+width-15, this.y, 0, 46 + k * 20, 15, this.height, 200, 20, 2, 3, 2, 2, blitOffset, false);
