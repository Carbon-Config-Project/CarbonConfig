	...
	public void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
		if(state.isSimpleButton()) {
			...
			if(icon != null) {
				...
				GuiUtils.blitWithBorder(graphics, WIDGETS_LOCATION, this.getX(), this.getY(), 0, 46 + k * 20, this.width, this.height, 200, 20, 2, 3, 2, 2, false);
		...
		GuiUtils.blitWithBorder(graphics, WIDGETS_LOCATION, this.getX(), this.getY(), 0, 46 + k * 20, this.width-14, this.height, 200, 20, 2, 3, 2, 2, false);
		GuiUtils.blitWithBorder(graphics, WIDGETS_LOCATION, this.getX()+width-15, this.getY(), 0, 46 + k * 20, 15, this.height, 200, 20, 2, 3, 2, 2, false);
