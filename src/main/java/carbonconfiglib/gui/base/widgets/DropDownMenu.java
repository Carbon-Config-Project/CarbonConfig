	...
	public void render(int mouseX, int mouseY, float partialTick) {
		if(state.isSimpleButton()) {
			...
			if(icon != null) {
				...
				GuiUtils.blitWithBorder(BUTTON_TEXTURES, this.xPosition, this.yPosition, 0, 46 + k * 20, this.width, this.height, 200, 20, 2, 3, 2, 2, zLevel, false);
		...
		GuiUtils.blitWithBorder(BUTTON_TEXTURES, this.xPosition, this.yPosition, 0, 46 + k * 20, this.width-14, this.height, 200, 20, 2, 3, 2, 2, zLevel, false);
		GuiUtils.blitWithBorder(BUTTON_TEXTURES, this.xPosition+width-15, this.yPosition, 0, 46 + k * 20, 15, this.height, 200, 20, 2, 3, 2, 2, zLevel, false);
		GuiUtils.drawScrollingShadowText(mc.fontRendererObj, displayString, xPosition+2, yPosition, width-18, height, Align.CENTER, j, 0);
		GuiUtils.drawScrollingShadowText(mc.fontRendererObj, Texts.literal(open ? (up ? "▲" : "▼") : "◀"), xPosition+width-13, yPosition, 11, height, Align.CENTER, j, 0);
	}
