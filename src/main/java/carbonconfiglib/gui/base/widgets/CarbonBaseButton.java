...
public class CarbonBaseButton extends GuiButton implements ITooltipProvider, IWidget
{
	...
	public CarbonBaseButton(int x, int y, int width, int height, ITextComponent message, Consumer<CarbonBaseButton> handler) {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		GuiUtils.blitWithBorder(BUTTON_TEXTURES, this.x, this.y, 0, 46 + k * 20, this.width, this.height, 200, 20, 2, 3, 2, 2, 0, false);
		GuiUtils.drawScrollingShadowText(mc.fontRenderer, displayString, x, y, width, height-2, Align.CENTER, this.enabled ? 16777215 : 10526880, 0);
	}
