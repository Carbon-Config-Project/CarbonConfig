...
public class CarbonBaseButton extends GuiButton implements ITooltipProvider, IWidget
{
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		GuiUtils.drawScrollingShadowText(mc.fontRenderer, displayString, xPosition, yPosition, width, height-2, Align.CENTER, this.enabled ? 16777215 : 10526880, 0);
	}
