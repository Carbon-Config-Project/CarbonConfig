...
public class CarbonButton extends CarbonBaseButton {
	...
	public void renderWidget(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
		...
		if(selected) {
			...
			GuiUtils.blitWithBorder(pPoseStack, WIDGETS_LOCATION, getX(), getY(), 0, 46 + k * 20, this.width, this.height, 200, 20, 2, 3, 2, 2, 0, true);
			RenderSystem.setShaderColor(1F, 1F, 1F, 1F);
		}
		else GuiUtils.blitWithBorder(pPoseStack, WIDGETS_LOCATION, getX(), getY(), 0, 46 + k * 20, this.width, this.height, 200, 20, 2, 3, 2, 2, 0, false);
		if(highlighted) {
